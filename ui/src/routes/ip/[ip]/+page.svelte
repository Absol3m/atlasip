<script lang="ts">
  ...
  import BgpCard from '$lib/components/BgpCard.svelte';
  import DnsRecordsCard from '$lib/components/DnsRecordsCard.svelte';
    ...
    <div class="groups" role="list" use:sortableAction>
      {#each visibleCards as card (card)}
        ...
        {:else if card === 'dns_records'}
          <DnsRecordsCard dnsRecords={record.dns_records} />
